 ...
 */
public class RbGroupView extends LinearLayout {


    private int childCount;

    public RbGroupView(Context context) {
        this(context, null);
    }

    public RbGroupView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RbGroupView(Context context, AttributeSet attrs, int defStyleAttr) {
